      ...
      <div className="mx-auto max-w-2xl px-4 py-0 sm:px-6 sm:py-3 lg:max-w-7xl lg:px-8">
        <div className=" grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          {products.map((product) => (
            <div
              key={product.id}
              className="group flex flex-col justify-between relative rounded-lg border border-gray-200 bg-white p-6 shadow-sm"
            >
              <div>
              ...
              <div className="mt-6 flex items-center justify-between">
                ...
                >
                  <ShoppingCartIcon className="w-3 h-3 inline text-white" />
